...
import { PasscodeChannelAuthorization } from 'kachery-js/types/kacheryHubTypes'
...
const EditPasscodeChannelAuthorization: FunctionComponent<Props> = ({authorization, onUpdateAuthorization}) => {
    const [editAuthorization, setEditAuthorization] = useState<PasscodeChannelAuthorization | undefined>(undefined)
...
export default EditPasscodeChannelAuthorization